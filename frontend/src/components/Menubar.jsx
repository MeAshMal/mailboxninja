...
const Menubar = () => {
  return (
    <menu className="fixed bottom-0 w-full  shadow-2xl shadow-black overflow-hidden max-w-[100vw]">
      <div className="links flex items-center justify-around w-full h-[10vh] bg-white rounded-b-lg max-w-[100vw] text-slate-500 fill-slate-500">
        <Link to="/">
